...
- Scratch accounts created in advance via a **teacher account** — see the Scratch Accounts Setup guide (Admin).
...
- Printed Week 1 handouts, name stickers, spare pencils.
